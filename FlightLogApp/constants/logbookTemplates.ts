...
export interface LogbookColumn {
  ...
  date_format?: string;       // för format:'date' — ordning dag/månad/år: 'iso'|'dmy'|'mdy'|'dmy2'|'mdy2'|'dmon'
}
...
export const LOGBOOK_TEMPLATES: LogbookTemplate[] = [
  ...
  },
  {
    ...
    left_columns: [
      ...
      { id: 'ac_mm',        label: 'Make-Mod',    flightKey: 'aircraft_type',format: 'text',     width: 80, group: 'RPAS / UAS / UAV' },
      { id: 'ac_reg',       label: 'Reg or S/N',  flightKey: 'registration', format: 'text',     width: 82, group: 'RPAS / UAS / UAV' },
      { id: 'location',     label: 'Location',    flightKey: 'dep_place',    format: 'text',     width: 80, group: 'Location of flight and times' },
      { id: 'dep_utc',      label: 'Start',       flightKey: 'dep_utc',      format: 'time-utc', width: 46, group: 'Location of flight and times' },
      { id: 'arr_utc',      label: 'Land',        flightKey: 'arr_utc',      format: 'time-utc', width: 46, group: 'Location of flight and times' },
      { id: 'mission',      label: 'Type/Cat',    flightKey: 'mission_cat',  format: 'text',     width: 60, group: 'Type and Cat of mission' },
      { id: 'total_time',   label: 'Total time',  flightKey: 'total_time',   format: 'decimal',  width: 56 },
      { id: 'multi_rotor',  label: 'Multi-rotor', flightKey: 'multi_rotor',  format: 'decimal',  width: 56 },
      { id: 'single_rotor', label: 'Single-rotor',flightKey: 'single_rotor', format: 'decimal',  width: 56 },
      { id: 'fixed_wing',   label: 'Fixed-wing',  flightKey: 'fixed_wing',   format: 'decimal',  width: 56 },
    ],
    right_columns: [
      { id: 'pic',          label: 'PIC',         flightKey: 'pic',          format: 'decimal',  width: 48, group: 'Pilot function time' },
      { id: 'co_pilot_fpv', label: 'Co-Pilot',    flightKey: 'co_pilot_fpv', format: 'decimal',  width: 52, group: 'Pilot function time' },
      { id: 'dual',         label: 'Dual',        flightKey: 'dual',         format: 'decimal',  width: 48, group: 'Pilot function time' },
      { id: 'instructor',   label: 'Instructor',  flightKey: 'instructor',   format: 'decimal',  width: 60, group: 'Pilot function time' },
      { id: 'ifr',          label: 'IFR',         flightKey: 'ifr',          format: 'decimal',  width: 46, group: 'Operational condition time' },
      { id: 'night',        label: 'Night',       flightKey: 'night',        format: 'decimal',  width: 48, group: 'Operational condition time' },
      { id: 'vlos',         label: 'VLOS',        flightKey: 'vlos',         format: 'decimal',  width: 48, group: 'Operational condition time' },
      { id: 'bvlos',        label: 'BVLOS',       flightKey: 'bvlos',        format: 'decimal',  width: 50, group: 'Operational condition time' },
      { id: 'ldg_day',      label: 'D',           flightKey: 'landings_day', format: 'int',      width: 40, group: 'Landings' },
      { id: 'ldg_night',    label: 'N',           flightKey: 'landings_night',format: 'int',     width: 40, group: 'Landings' },
      { id: 'remarks',      label: 'Remarks and endorsement', flightKey: 'remarks', format: 'text', width: 200 },
    ],
    header_rows: [
      [
        { label: 'Date of flight', sub: 'dd/mm/yyy', rowSpan: 3 },
        { label: 'RPAS / UAS / UAV', colSpan: 2 },
        { label: 'Location of flight and times', colSpan: 3 },
        { label: 'Type and Cat of mission', rowSpan: 3 },
        { label: 'Total time', rowSpan: 3 },
        { label: 'Multi-rotor', rowSpan: 3 },
        { label: 'Single-rotor', rowSpan: 3 },
        { label: 'Fixed-wing', rowSpan: 3 },
        { label: 'Pilot function time', colSpan: 4 },
        { label: 'Operational condition time', colSpan: 4 },
        { label: 'Landings', sub: 'Day / Night', colSpan: 2 },
        { label: 'Remarks and endorsement', rowSpan: 3 },
      ],
      [
        { label: 'Make-Mod', rowSpan: 2 },
        { label: 'Reg or S/N', rowSpan: 2 },
        { label: 'Location', rowSpan: 2 },
        { label: 'Start', dashR: true },
        { label: 'Land' },
        { label: 'PIC', rowSpan: 2, dashR: true },
        { label: 'Co-Pilot', sub: '(FPV)', rowSpan: 2, dashR: true },
        { label: 'Dual', rowSpan: 2, dashR: true },
        { label: 'Instructor', rowSpan: 2 },
        { label: 'IFR', rowSpan: 2, dashR: true },
        { label: 'Night', rowSpan: 2, dashR: true },
        { label: 'VLOS', rowSpan: 2, dashR: true },
        { label: 'BVLOS', rowSpan: 2 },
        { label: 'D', rowSpan: 2, dashR: true },
        { label: 'N', rowSpan: 2 },
      ],
      [
        { label: 'UTC' },
