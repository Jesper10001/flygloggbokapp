...
export const LOGBOOK_TEMPLATES: LogbookTemplate[] = [
  ...
  {
    id: 'sv-drone-logbook',
    name: 'Drone Logbook (15 rows)',
    rows_per_spread: 15,
    language: 'sv',
    time_format: 'decimal',
    left_columns: [
      { id: 'date',         label: 'Date',           flightKey: 'date',         format: 'date',     width: 90 },
      { id: 'ac_type',      label: 'Drone type',     flightKey: 'aircraft_type',format: 'text',     width: 85 },
      { id: 'ac_reg',       label: 'Registration',   flightKey: 'registration', format: 'text',     width: 85 },
      { id: 'dep_place',    label: 'Place',          flightKey: 'dep_place',    format: 'icao',     width: 75 },
      { id: 'dep_utc',      label: 'Start UTC',      flightKey: 'dep_utc',      format: 'time-utc', width: 65 },
      { id: 'arr_utc',      label: 'Landing UTC',    flightKey: 'arr_utc',      format: 'time-utc', width: 75 },
      { id: 'total_time',   label: 'Total time',     flightKey: 'total_time',   format: 'decimal',  width: 70 },
    ],
    right_columns: [
      { id: 'pic',          label: 'PIC',            flightKey: 'pic',          format: 'decimal',  width: 55 },
      { id: 'ifr',          label: 'IFR',            flightKey: 'ifr',          format: 'decimal',  width: 50 },
      { id: 'night',        label: 'Night',          flightKey: 'night',        format: 'decimal',  width: 55 },
      { id: 'distance',     label: 'Distance (km)',                                                 width: 85 },
      { id: 'altitude',     label: 'Max alt (m)',                                                   width: 85 },
      { id: 'battery',      label: 'Battery %',                                                    width: 75 },
      { id: 'remarks',      label: 'Notes',          flightKey: 'remarks',      format: 'text',     width: 200 },
    ],
    footer: {
      this_page_total: true,
      total_to_date: true,
