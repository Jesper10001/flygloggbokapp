...
const ALL_COLUMNS: { key: string; header: string }[] = [
  ...
  { key: 'pilot_flying', header: 'Pilot flying' },
  { key: 'ifr', header: 'IFR' },
  { key: 'vfr', header: 'VFR' },
  { key: 'night', header: 'Night' },
  { key: 'nvg', header: 'NVG' },
  { key: 'takeoffs_day', header: 'Takeoffs day' },
  { key: 'takeoffs_night', header: 'Takeoffs night' },
  { key: 'takeoffs_faa_night', header: 'Takeoffs night (FAA)' },
  { key: 'landings_day', header: 'Landings day' },
  { key: 'landings_night', header: 'Landings night' },
  { key: 'tng_count', header: 'Touch & Go' },
  { key: 'app_2d', header: 'Approaches 2D' },
  { key: 'app_3d', header: 'Approaches 3D' },
  { key: 'holds', header: 'Holds' },
  { key: 'max_fl', header: 'Max FL' },
  { key: 'flight_rules', header: 'Flight rules' },
  { key: 'second_pilot', header: 'Second pilot' },
  { key: 'second_pilot_role', header: 'Second pilot role' },
