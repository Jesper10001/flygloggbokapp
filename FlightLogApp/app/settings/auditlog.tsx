...
const FIELD_LABELS: Record<string, string> = {
  date: 'Datum', aircraft_type: 'Typ', registration: 'Reg',
  dep_place: 'Avgång', dep_utc: 'Avg.tid', arr_place: 'Ankomst', arr_utc: 'Ank.tid',
  total_time: 'Flygtid', pic: 'PIC', co_pilot: 'Co-pilot', dual: 'Dual',
  ifr: 'IFR', night: 'Natt', landings_day: 'Land.dag', landings_night: 'Land.natt',
  remarks: 'Anmärkningar', status: 'Status',
};
  ...
  if (!entries.length) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.emptyText}>Inga ändringar loggade ännu</Text>
        <Text style={styles.emptySubtext}>
          Ändringar av loggade flygningar visas här med originalvärde och nytt värde.
        </Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      <View style={styles.notice}>
        ...
        <Text style={styles.noticeText}>
          Ändringsloggen kan aldrig raderas och exporteras alltid med loggboken.
        </Text>
      </View>
...
function AuditRow({ entry }: { entry: AuditEntry }) {
  ...
  return (
    <View style={styles.row}>
      ...
      {entry.reason ? (
        <Text style={styles.reason}>Anledning: {entry.reason}</Text>
      ) : null}
    </View>
  );
}
